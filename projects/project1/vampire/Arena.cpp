...
:m_rows(nRows), m_cols(nCols), m_player(nullptr), m_nVampires(0), m_turns(0), m_history(nRows, nCols)
{
...
void Arena::moveVampires() // TODO: add record function
{
      // Move all vampires
...
//        TODO: if (vp->health = 1 || vp->!isDead()) { m_history.record(vp->row(),vp->col() }
    }
